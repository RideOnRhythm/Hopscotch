...
class RoleOrganizer(commands.Cog):
    ...
    async def on_member_update(self, before, after):
        if before.roles == after.roles or after.bot:
            return
        exclusive_roles = [1064445950992597042, 1052103824346710056, 858166817145880587, 957799704660439041, 1044612642599358475, 957803140864950302, 858222265098174474, 858228707767877632, 1026064526698889286, 1067326246867980318, 1036568309501526026, 1036842427622903878, 1063688787722522666, 1055792475245129759, 1058290811835531304, 1045704861783695450, 1048233290143907900, 1048233980329213983, 1048234335930683473]
